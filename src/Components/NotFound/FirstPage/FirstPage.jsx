            ...
            <div className="container"style={{height:'100vh'}}>
                <div className="row">
                    <div className="col-sm-12 col-md-12 mt-5">
                        <Buttons go={'/landing'} title={'بازگشت'} classSpan={'ms-2'} bg={'rgb(93, 97, 97)'} />
                        <svg width="100%" height="500" viewBox="0 0 636 324" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g id="OBJECTS">
                                <g id="Group">
                                    <path id="Vector"
                        ...
                        <div className='text-center'>
                            <span className='d-block fs-3 mb-3'>صفحه مورد نظر شما یافت نشد !</span>
                            <Buttons go={'/'} title={'رفتن به صفحه اصلی'} classSpan={'ms-2'} bg={'rgb(93, 97, 97)'}  />
                        </div>
                        <span className='pb-5'>راهنمایی:<br /> آدرس اینترنتی خود را چک کنید و از صحیح بودن آن مطمئن باشید <br />ممکن است صفحه مورد نظر شما حذف شده باشد !</span>
                    </div>
                </div>
            </div>
        </>
